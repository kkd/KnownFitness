    ...
    foreach ($attachments as $attachment) {
        ...
        <script type="application/javascript">
            function display_gpx<?= $attachment['_id'] ?>(elt) {
                ...
                async: true,
                marker_options: {
                    startIconUrl: '<?php echo \Idno\Core\Idno::site()->config()->getDisplayURL() ?>IdnoPlugins/Fitness/external/leaflet-gpx/pin-icon-start.png',
                    endIconUrl:   '<?php echo \Idno\Core\Idno::site()->config()->getDisplayURL() ?>IdnoPlugins/Fitness/external/leaflet-gpx/pin-icon-end.png',
                    shadowUrl:    '<?php echo \Idno\Core\Idno::site()->config()->getDisplayURL() ?>IdnoPlugins/Fitness/external/leaflet-gpx/pin-shadow.png',
                    },
                });
...
<?= $this->autop($this->parseHashtags($this->parseURLs($object->notes, $rel))) ?>
